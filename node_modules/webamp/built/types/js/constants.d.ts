import { Band, MediaTagRequestStatus, MediaStatus, LoadStyle, TimeMode, WindowId, PlayerMediaStatus } from "./types";
...
export declare const PLAYER_MEDIA_STATUS: Record<PlayerMediaStatus, PlayerMediaStatus>;
