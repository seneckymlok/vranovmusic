 ...
 */
export type PlayerMediaStatus = "PLAYING" | "STOPPED" | "PAUSED"
...
export interface IMusicMetadataApi {
     ...
     * @returns Metadata
     */
    parseWebStream(webStream: AnyWebByteStream, fileInfo?: IFileInfo | string, options?: IOptions): Promise<IAudioMetadata>;
    /**
     * Parse Web API File
     * @param {Blob} blob
     * @param {IOptions} options Parsing options
