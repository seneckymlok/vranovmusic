import { AppState, PlaylistTrack, WebampWindow, WindowId, LoadedURLTrack, PlaylistStyle, TransitionType, TimeMode, SkinImages, Cursors, SkinRegion, GenLetterWidths, MilkdropMessage, DummyVizData, PlayerMediaStatus, MediaStatus } from "./types";
...
export declare const getPlaylistTracks: import("reselect").OutputSelector<AppState, PlaylistTrack[], (res1: fromTracks.TracksState, res2: number[]) => PlaylistTrack[]>;
...
export declare const getSelectedTrackIds: (state: AppState) => Array<number>;
export declare const getSelectedTrackIdsSet: import("reselect").OutputSelector<AppState, Set<number>, (res: number[]) => Set<number>>;
...
export declare const getPlayerMediaStatus: (state: AppState) => PlayerMediaStatus;
export declare const getMediaStatus: import("reselect").OutputSelector<AppState, MediaStatus, (res: PlayerMediaStatus) => MediaStatus>;
...
export declare function getMilkdropEnabled(state: AppState): boolean;
